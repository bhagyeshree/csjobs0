...
public class Application implements Serializable {
    ...
    private Fileu researchStatement;

    @OneToOne
    @JoinColumn(name = "teaching_statement_id")
    private Fileu teachingStatement;
    ...
    public void setCv( Fileu cv )
    {
        this.cv = cv;
    }

    public Fileu getResearchStatement()
    {
        return researchStatement;
    }

    public void setResearchStatement( Fileu researchStatement )
    {
        this.researchStatement = researchStatement;
    }

    public Fileu getTeachingStatement()
    {
        return teachingStatement;
    }

    public void setTeachingStatement( Fileu teachingStatement )
    {
