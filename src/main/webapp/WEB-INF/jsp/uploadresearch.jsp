			...
			<div class="panel-body">
				...
				<div class="form-group">
					<center>
						...
						<form:form
							action="uploadresearch.html?applicationId=${application.id }"
							name="research" method="post" enctype="multipart/form-data">
								...
								<div class="input-group">
									...
									<div class="input-group-btn">
										<span class="btn btn-file btn-light-green"><i
											...
											name="filereserch" type="file" required> </span> &times; </a>
									</div>
								</div>
							</div>
							...
							<br />
							<br />
							<input type="submit" name="uploadresearch" value="uploadresearch"
								class="btn btn-primary" />
							<a href="<c:url value='/applicant.html' />">Skip</a>
						</form:form>
					</center>
				</div>
			</div>
