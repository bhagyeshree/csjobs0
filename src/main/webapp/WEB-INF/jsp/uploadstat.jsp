			...
			<div class="panel-body">
				...
				<div class="form-group">
					<center>
						...
						<form:form
							action="uploadstat.html?applicationId=${application.id }"
								...
								<div class="input-group">
									...
									<div class="input-group-btn">
										<span class="btn btn-file btn-light-green"><i
											...
											accept="application/pdf,application/msword" name="filestat"
							...
							<br />
							<br />
							<input type="submit" name="uploadstat" value="uploadstat"
								class="btn btn-primary" />
							<a
								href="<c:url value='/uploadresearch.html?applicationId=${application.id }' />">Skip</a>
						</form:form>
					</center>
				</div>
			</div>
