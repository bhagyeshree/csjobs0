				...
				<div class="panel-body">
					<div class="panel panel-white">
						<div class="form-group">
							...
							<form:form action="edit.html?jobId=${job.id}"
								modelAttribute="job">
								<table class="table">
									<tr>
										<th>Title:</th>
									...
									<tr>
										...
										<td><c:forEach items="${authenticated }"
												...
												<c:forEach items="${templist }" var="templist">
													...
													<c:choose>
														<c:when test="${authenticated.id eq templist.id }">
															<input type="checkbox" value="${authenticated.id }"
																name="committeeMembers" checked="checked" />${authenticated.firstName } ${authenticated.lastName }<br />
												...
												<c:if test="${found==0 }">
													<input type="checkbox" value="${authenticated.id }"
														name="committeeMembers" />${authenticated.firstName } ${authenticated.lastName }<br />
												</c:if>
