		...
		<div class="row">
			...
			<div class="panel-body">
				<center>
					...
					<p>
						<b>Committee Chair:</b>${job.committeeChair.firstName }${job.committeeChair.lastName }<br/>
					
					</p>
					
					<p>
						<b>Committee Members:</b><br/><c:forEach items="${clist }" var="clist">${clist.firstName }${clist.lastName }<br/></c:forEach>
